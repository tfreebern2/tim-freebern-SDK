...
import 'package:the_one_sdk/src/models/movie.dart';
...
void main() {
  group('Test Movie Data Model', () {
    test('fromJson', () {
      ...
      final response = json.map((movie) => Movie.fromJson(movie)).toList();
      expect(response[1].rottenTomatoesScore, 66.33333333);
      expect(response[6].boxOfficeRevenueInMillions, 871.5);
    });
  });
}
